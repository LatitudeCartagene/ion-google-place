  ...
  .directive('ionGooglePlace', [
      ...
      return {
        ...
        link: function (scope, element, attrs, ngModel) {
          if (!scope.$root.api) {
            var api = document.querySelector('google-maps-api');
            api.addEventListener('api-load', function (e) {
              link(scope, element, attrs, ngModel, $ionicTemplateLoader, $ionicBackdrop, $ionicPlatform, $q, $timeout, $rootScope, $document);
            });
          } else {
            link(scope, element, attrs, ngModel, $ionicTemplateLoader, $ionicBackdrop, $ionicPlatform, $q, $timeout, $rootScope, $document);
          }
...
var link = function (scope, element, attrs, ngModel, $ionicTemplateLoader, $ionicBackdrop, $ionicPlatform, $q, $timeout, $rootScope, $document) {
  ...
  ngModel.$render = function () {
    ...
    scope.$root.$broadcast('smitec.google-place', {
      model: ngModel,
      type: attrs.ngModel
    });
  };
